<?php
if( !function_exists( 'aza_social_section' ) ) {

    function aza_social_section() {

        $frontpage_social_toggle = get_theme_mod( 'frontpage_social_toggle', false );
        if( ( bool ) $frontpage_social_toggle === true ) {
            return;
        }
