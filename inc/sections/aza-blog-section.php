 ...
 * Blog Section
 */
if( !function_exists( 'aza_blog_section' ) ) {

    function aza_blog_section() {

        $frontpage_blog_toggle = get_theme_mod( 'frontpage_blog_toggle', false );
        if( ( bool ) $frontpage_blog_toggle === true ) {
            return;
        }
