<?php
if( !function_exists( 'aza_contact_section' ) ) {

    function aza_contact_section() {

        $frontpage_contact_toggle = get_theme_mod( 'frontpage_contact_toggle', false );
        if( ( bool ) $frontpage_contact_toggle === true ) {
            return;
        }
