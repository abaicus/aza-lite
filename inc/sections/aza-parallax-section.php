<?php
if( !function_exists( 'aza_parallax_section' ) ) {

    function aza_parallax_section() {

        $frontpage_parallax_toggle = get_theme_mod( 'frontpage_parallax_toggle', false );
        if( ( bool ) $frontpage_parallax_toggle === true ) {
            return;
        }
