                   ...
                   <?php
                    if((empty($button_text))||(empty($text)))
                    {
                        ...
                        if(!empty($button_text)) {
                            echo '<button type="button" onclick="window.location='.esc_url($button_link).' class="btn features-btn center-block">'.esc_html($button_text).'</button>';
                        } else if(!empty($text)) {
                        ...
                        <button type="button" onclick="window.location='.esc_url($button_link).'" class="btn features-btn center-block">'.esc_html($button_text).'</button></div>';
                    }
